...
def group_lines_and_draw_bridge(img,lines,side):
        """
    ...
    #             action_append("Back1Run")
        ...
        if event_step_bridge == 2:
            ...
            lines = cv2.HoughLinesP(blank_img,
                        ...
                        minLineLength=10,
                        maxLineGap=15)
            final_image, Final_line, good = group_lines_and_draw_bridge(blank_img, lines, 'Right')
...
if __name__ == '__main__':
    ...
    Chest_path = 'E:\\qq\\2286239618\\FileRecv\\final image test\\gb2.jpg'
